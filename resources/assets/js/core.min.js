function updateComments(t) {
  var e = $(t).val(),
    n = e.length;
  $(".characterInfo .currentLength", $(t).parent().parent()).html(n);
  var o = $(t).data("name") ? $(t).data("name") : "";
  if (o.length > 0) {
    var i = -1 === e.indexOf(o);
    $(".characterInfo .commentStatusName", $(t).parent().parent()).toggleClass(
      "hidden",
      !i
    );
  }
  var r = $(t).data("gender") ? $(t).data("gender") : "";
  if (r.length > 0) {
    var a =
        -1 !== e.search(/\bhe\b/i) ||
        -1 !== e.search(/\bhis\b/i) ||
        -1 !== e.search(/\bhim\b/i) ||
        -1 !== e.search(/\bhimself\b/i),
      l =
        -1 !== e.search(/\bshe\b/i) ||
        -1 !== e.search(/\bher\b/i) ||
        -1 !== e.search(/\bherself\b/i),
      s = (a && "F" == r) || (l && "M" == r);
    $(".characterInfo .commentStatusPronoun", $(t).parent()).toggleClass(
      "hidden",
      !s
    );
  }
...
function updatePlaceholders(t) {
  var e = $(t).val(),
    n = $(t).data("name") ? $(t).data("name") : "";
  n.length > 0 && (e = e.replace(/{name}/gi, n));
  var o = $(t).data("gender") ? $(t).data("gender") : "";
  o.length > 0 &&
    ("F" == o
      ? (e = (e = (e = (e = e
          .replace(/\bhe\b/g, "she")
          ...
          .replace(/\bHimself\b/g, "Herself"))
      : "M" == o &&
        (e = (e = (e = e.replace(/\bshe\b/g, "he").replace(/\bShe\b/g, "He"))
...
!(function (t, e) {
    ...
    if (t.getBoundingClientRect || t === window) {
      ...
      if (
        ...
        do {
          if (
            ...
            (a -= p.top + parseInt(k(i, "border-top-width"))),
              (l -= p.left + parseInt(k(i, "border-left-width"))),
              (s = a + r.height),
              (d = l + r.width);
            break;
          }
      ...
      if (o && t !== window) {
        var f = D(i || t),
          m = f && f.a,
          g = f && f.d;
        f && ((s = (a /= g) + (u /= g)), (d = (l /= m) + (h /= m)));
      }
      return { top: a, left: l, bottom: s, right: d, width: h, height: u };
    }
  }
  function T(t, e, n) {
    for (var o = N(t, !0), i = _(t)[e]; o; ) {
      var r = _(o)[n];
  ...
  function A(t, e) {
    for (
      ...
      n && (n === Lt.ghost || "none" === k(n, "display") || (e && !b(n, e)));
      ...
      captureAnimationState: function () {
        ((n = []), this.options.animation) &&
          [].slice.call(this.el.children).forEach(function (t) {
            if ("none" !== k(t, "display") && t !== Lt.ghost) {
              n.push({ target: t, rect: _(t) });
  ...
  var U = [],
    ...
    K = {
      ...
      initializePlugins: function (t, e, n, o) {
        for (var r in (U.forEach(function (o) {
          var r = o.pluginName;
  ...
  function W(t) {
    ...
    if ((n = n || (o && o[F]))) {
      ...
      !window.CustomEvent || c || d
        ...
        (b.newDraggableIndex = f),
        (b.originalEvent = m),
        (b.pullMode = g ? g.lastPutMode : void 0);
      var E = e(e({}, v), K.getEventProperties(i, n));
        ...
        e(
          {
            ...
            dispatchSortableEvent: function (t) {
              q({ sortable: n, name: t, originalEvent: i });
            },
          },
          a
        )
  ...
  var Q,
    ...
    At = p,
    Bt = d || c ? "cssFloat" : "float",
    Ot = Mt && !f && !p && "draggable" in document.createElement("div"),
    Nt = (function () {
      if (Mt) {
        if (c) return !1;
    ...
    It = function (t, e) {
      var n = k(t),
        ...
        a = i && k(i),
        l = r && k(r),
        s = a && parseInt(a.marginLeft) + parseInt(a.marginRight) + _(i).width,
        c = l && parseInt(l.marginLeft) + parseInt(l.marginRight) + _(r).width;
      if ("flex" === n.display)
  ...
  var Xt = function (t) {
    ...
    Yt = function (t) {
      Q && Q.parentNode[F]._isOutsideThisEl(t.target);
    };
  function Lt(t, e) {
    ...
    (this.el = t), (this.options = e = i({}, e)), (t[F] = this);
    var n = {
      group: null,
      sort: !0,
      disabled: !1,
      ...
      supportPointer:
        !1 !== Lt.supportPointer && "PointerEvent" in window && !h,
      emptyInsertThreshold: 5,
    };
    for (var o in (K.initializePlugins(this, t, n), n))
      !(o in e) && (e[o] = n[o]);
    for (var r in (Pt(e), this))
      "_" === r.charAt(0) &&
  ...
  (Lt.prototype = {
      ...
      if (t.cancelable) {
        ...
        if (
          ...
          !Q &&
            ...
            !(((l = w(l, o.draggable, n, !1)) && l.animated) || nt === l))
        ) {
          if (((rt = B(l)), (lt = B(l, o.draggable)), "function" == typeof c)) {
    ...
    _prepareDragStart: function (t, e, n) {
      ...
      if (n && !Q && n.parentNode === r) {
        ...
        if (
          ...
          V("delayStart", this, { evt: t }),
          !a.delay ||
            (a.delayOnTouchOnly && !e) ||
            (this.nativeDraggable && (d || c)))
        )
          o();
        else {
    ...
    _triggerDragStart: function (t, e) {
      (e = e || ("touch" == t.pointerType && t)),
        !this.nativeDraggable || e
          ...
          : (g(Q, "dragend", this), g(tt, "dragstart", this._onDragStart));
      try {
        document.selection
          ? Kt(function () {
    ...
    _dragStarted: function (t, e) {
      if (((St = !1), tt && Q)) {
        V("dragStarted", this, { evt: e }),
          this.nativeDraggable && g(document, "dragover", Yt);
        var n = this.options;
        !t && $(Q, n.dragClass, !1),
          $(Q, n.ghostClass, !0),
          (Lt.active = this),
    ...
    _emulateDragOver: function () {
      if (ht) {
        (this._lastX = ht.clientX), (this._lastY = ht.clientY), Rt();
        for (
          ...
          e = t;
        if ((Q.parentNode[F]._isOutsideThisEl(t), e))
          do {
            if (e[F]) {
              if (
                e[F]._onDragOver({
      ...
      if (!J) {
        ...
        if (At) {
          ...
          Et !== document.body && Et !== document.documentElement
            ? (Et === document && (Et = x()),
              (e.top += Et.scrollTop),
              (e.left += Et.scrollLeft))
            : (Et = x()),
            (xt = O(Et));
        }
        $((J = Q.cloneNode(!0)), n.ghostClass, !1),
          $(J, n.fallbackClass, !0),
          $(J, n.dragClass, !0),
          k(J, "transition", ""),
          k(J, "transform", ""),
          k(J, "box-sizing", "border-box"),
          k(J, "margin", 0),
          k(J, "top", e.top),
          k(J, "left", e.left),
          k(J, "width", e.width),
          k(J, "height", e.height),
          k(J, "opacity", "0.8"),
          k(J, "position", At ? "absolute" : "fixed"),
          k(J, "zIndex", "100000"),
          k(J, "pointerEvents", "none"),
          (Lt.ghost = J),
          t.appendChild(J),
          k(
            J,
            "transform-origin",
            (mt / parseInt(J.style.width)) * 100 +
              "% " +
              (gt / parseInt(J.style.height)) * 100 +
              "%"
          );
      }
    },
    _onDragStart: function (t, e) {
      var n = this,
        o = t.dataTransfer,
        i = n.options;
      V("dragStart", this, { evt: t }),
        Lt.eventCanceled
          ? this._onDrop()
          : (V("setupClone", this),
            Lt.eventCanceled ||
              ((ot = H(Q)).removeAttribute("id"),
              (ot.draggable = !1),
              (ot.style["will-change"] = ""),
              this._hideClone(),
              $(ot, this.options.chosenClass, !1),
              (Lt.clone = ot)),
            (n.cloneId = Kt(function () {
              V("clone", n),
                Lt.eventCanceled ||
                  (n.options.removeCloneOnHide || tt.insertBefore(ot, Q),
                  n._hideClone(),
                  q({ sortable: n, name: "clone" }));
            })),
            !e && $(Q, i.dragClass, !0),
            e
              ? (($t = !0), (n._loopId = setInterval(n._emulateDragOver, 50)))
        ...
        if (
          ...
          d &&
            ...
            (u
              ? h || (i = Z !== tt)
              : dt === this ||
                ((this.lastPutMode = ct.checkPull(this, d, Q, t)) &&
                  c.checkPut(this, d, Q, t))))
        ) {
          if (
          ...
          if (i)
            return (
              ...
              X("revert"),
              Lt.eventCanceled ||
                (et ? tt.insertBefore(Q, et) : tt.appendChild(Q)),
              j(!0)
            );
          var g = A(a, s.draggable);
          if (
            !g ||
            ((function (t, e, n) {
              var o = _(A(n.el, n.options.draggable)),
                i = L(n.el, n.options, J),
                r = 10;
              return e
                ? t.clientX > i.right + r ||
                    (t.clientY > o.bottom && t.clientX > o.left)
                : t.clientY > i.bottom + r ||
            ...
            var v = M(a, 0, s, !0);
            if (v === Q) return j(!1);
            if (((o = _((l = v))), !1 !== Ft(tt, a, Q, n, l, o, t, !1)))
              return Y(), a.insertBefore(Q, v), (Z = a), U(), j(!0);
            ...
            var b,
              ...
              D = !(function (t, e, n) {
                ...
                (Q.animated && Q.toRect) || n,
                (l.animated && l.toRect) || o,
                r
              ),
              C = r ? "top" : "left",
              x = T(l, "top", "top") || T(Q, "top", "top"),
              O = x ? x.scrollTop : void 0;
            if (
              (bt !== l &&
                ((y = o[C]), (Dt = !1), (Ct = (!D && s.invertSwap) || S)),
                ...
                if (!a)
                  if (l && wt < c * i) {
                    if (
                      ...
                      h = !0;
                    else if (1 === yt ? s < d + wt : s > u - wt) return -yt;
                  } else if (
                    s > d + (c * (1 - i)) / 2 &&
                    s < u - (c * (1 - i)) / 2
                  )
              ...
              do {
                (N -= b), (E = Z.children[N]);
              } while (E && ("none" === k(E, "display") || E === J));
            }
            if (0 === b || E === l) return j(!1);
            (bt = l), (yt = b);
            var I = l.nextElementSibling,
              P = !1,
              H = Ft(tt, a, Q, n, l, o, t, (P = 1 === b));
            if (!1 !== H)
              return (
                (1 !== H && -1 !== H) || (P = 1 === H),
                (_t = !0),
                ...
                P && !I
                  ? a.appendChild(Q)
                  : l.parentNode.insertBefore(Q, P ? I : l),
                x && R(x, 0, O - x.scrollTop),
                (Z = Q.parentNode),
                void 0 === y || Ct || (wt = Math.abs(y - _(l)[C])),
                U(),
                j(!0)
              );
          }
          if (a.contains(Q)) return j(!1);
        }
        return !1;
      }
      function X(s, c) {
      ...
      function j(e) {
        return (
          ...
          e &&
            ...
            f !== p &&
              ($(Q, dt ? dt.options.ghostClass : d.options.ghostClass, !1),
              $(Q, s.ghostClass, !0)),
            dt !== f && f !== Lt.active
              ? (dt = f)
              : f === Lt.active && dt && (dt = null),
          ...
          ((l === Q && !Q.animated) || (l === a && !l.animated)) && (bt = null),
          s.dragoverBubble ||
            t.rootEl ||
            l === document ||
            (Q.parentNode[F]._isOutsideThisEl(t.target), !e && Xt(t)),
    ...
    _offMoveEvents: function () {
      v(document, "mousemove", this._onTouchMove),
        ...
        v(document, "dragover", Xt),
        v(document, "mousemove", Xt),
        v(document, "touchmove", Xt);
    },
    ...
    _onDrop: function (t) {
      ...
      (at = B(Q)),
        ...
        Lt.eventCanceled ||
          ...
          this.nativeDraggable &&
            (v(document, "drop", this), v(e, "dragstart", this._onDragStart)),
          this._offMoveEvents(),
          this._offUpEvents(),
          h && k(document.body, "user-select", ""),
          k(Q, "transform", ""),
          t &&
            (vt &&
              (t.cancelable && t.preventDefault(),
            ...
            (tt === Z || (dt && "clone" !== dt.lastPutMode)) &&
              ot &&
              ot.parentNode &&
              ot.parentNode.removeChild(ot),
            Q &&
              (this.nativeDraggable && v(Q, "dragend", this),
              jt(Q),
              (Q.style["will-change"] = ""),
              vt &&
                !St &&
                $(Q, dt ? dt.options.ghostClass : this.options.ghostClass, !1),
              $(Q, this.options.chosenClass, !1),
              q({
                sortable: this,
                name: "unchoose",
                toEl: Z,
    ...
    toArray: function () {
      for (
        ...
        w((t = n[o]), r.draggable, this.el, !1) &&
          e.push(t.getAttribute(r.dataIdAttr) || zt(t));
      return e;
    },
    sort: function (t, e) {
      var n = {},
    ...
    _hideClone: function () {
      if (!it) {
        if ((V("hideClone", this), Lt.eventCanceled)) return;
        k(ot, "display", "none"),
    ...
    _showClone: function (t) {
      if ("clone" === t.lastPutMode) {
        if (it) {
          if ((V("showClone", this), Lt.eventCanceled)) return;
          Q.parentNode != tt || this.options.group.revertClone
            ? et
              ? tt.insertBefore(ot, et)
              : tt.appendChild(ot)
            : tt.insertBefore(ot, Q),
            this.options.group.revertClone && this.animate(Q, ot),
            k(ot, "display", ""),
            (it = !1);
        }
    ...
    Mt &&
      g(document, "touchmove", function (t) {
        (Lt.active || St) && t.cancelable && t.preventDefault();
      }),
    (Lt.utils = {
      on: g,
      off: v,
    ...
    (Lt.mount = function () {
      ...
      n[0].constructor === Array && (n = n[0]),
        n.forEach(function (t) {
          ...
          t.utils && (Lt.utils = e(e({}, Lt.utils), t.utils)), K.mount(t);
        });
    }),
            ...
            ? ((E =
              ...
              (S =
                ...
                ("auto" === C.overflowY ||
                  ...
                  "visible" === C.overflowY)))
            : ((E =
                y < $ && ("auto" === C.overflowX || "scroll" === C.overflowX)),
              (S =
                w < D && ("auto" === C.overflowY || "scroll" === C.overflowY)));
          var A =
              E &&
              (Math.abs(b - r) <= l && T + y < $) -
                (Math.abs(v - r) <= l && !!T),
            B =
              S &&
              (Math.abs(g - a) <= l && M + w < D) -
                (Math.abs(m - a) <= l && !!M);
          if (!te[u]) for (var O = 0; O <= u; O++) te[O] || (te[O] = {});
          (te[u].vx == A && te[u].vy == B && te[u].el === p) ||
            ((te[u].el = p),
            (te[u].vx = A),
            (te[u].vy = B),
            clearInterval(te[u].pid),
            (0 == A && 0 == B) ||
              ((d = !0),
              (te[u].pid = setInterval(
                function () {
                  ...
                  ("function" == typeof i &&
                    ...
                    R(te[this.layer].el, n, e);
                }.bind({ layer: u }),
                24
              )))),
            u++;
        } while (e.bubbleScroll && h !== c && (h = N(h, !1)));
        ee = d;
      }
    }, 30),
    ae = function (t) {
      ...
      new (function () {
        ...
        return (
          (t.prototype = {
            ...
            nulling: function () {
              (Zt = Vt = Gt = ee = Jt = qt = Qt = null), (te.length = 0);
            },
            ...
            _handleAutoScroll: function (t, e) {
              ...
              if (
                ((Zt = t),
                e || this.options.forceAutoScrollFallback || d || c || h)
              ) {
                ...
                !ee ||
                  ...
                  (Jt = setInterval(function () {
                    var r = N(document.elementFromPoint(o, i), !0);
                    r !== a && ((a = r), ne()), re(t, n.options, r, e);
                  }, 10)),
                  (qt = o),
                  (Qt = i));
              } else {
                if (!this.options.bubbleScroll || N(r, !0) === x())
                  return void ne();
                re(t, this.options, N(r, !1), !1);
              }
            },
          }),
          ...
          (t.prototype = {
            ...
            dragOverValid: function (t) {
              ...
              if (i.options.swap) {
                ...
                if (n && n !== l) {
                  var c = ie;
                  !1 !== o(n) ? ($(n, s.swapClass, !0), (ie = n)) : (ie = null),
                    c && c !== ie && $(c, s.swapClass, !1);
                }
                r(), e(!0), a();
              }
            },
        ...
        return (
          (t.prototype = {
            ...
            setupClone: function (t) {
              ...
              if (this.isMultiDrag) {
                for (var o = 0; o < fe.length; o++)
                  me.push(H(fe[o])),
                    (me[o].sortableIndex = fe[o].sortableIndex),
                    (me[o].draggable = !1),
                    (me[o].style["will-change"] = ""),
                    $(me[o], this.options.selectedClass, !1),
                    fe[o] === ue && $(me[o], this.options.chosenClass, !1);
                e._hideClone(), n();
              }
            },
            clone: function (t) {
              ...
              this.isMultiDrag &&
                (this.options.removeCloneOnHide ||
                  (fe.length && de === e && (ye(!0, n), o("clone"), i())));
            },
            ...
            revert: function (t) {
              ...
              fe.length > 1 &&
                (fe.forEach(function (t) {
                  o.addAnimationState({ target: t, rect: ve ? _(t) : i }),
                    Y(t),
                    (t.fromRect = i),
            ...
            dragOverCompleted: function (t) {
              ...
              if (o) {
                if (
                  ...
                  l.animation &&
                    fe.length > 1 &&
                    (ve || (!n && !i.options.sort && !a)))
                ) {
                  var s = _(ue, !1, !0, !0);
                  fe.forEach(function (t) {
                    t !== ue && (X(t, s), r.appendChild(t));
                  }),
                    (ve = !0);
                }
                if (!n)
                  if ((ve || we(), fe.length > 1)) {
                    var c = pe;
                    i._showClone(e),
                      i.options.animation &&
                        !pe &&
              ...
              if (e) {
                ...
                if (!be)
                  if (
                    ...
                    $(ue, c.selectedClass, !~fe.indexOf(ue)),
                    ~fe.indexOf(ue))
                  )
                    fe.splice(fe.indexOf(ue), 1),
                      (ce = null),
                      W({
                        sortable: i,
                        rootEl: n,
                    ...
                    if (
                      ...
                      if (~p && ~f && p !== f)
                        for (
                          f > p ? ((h = p), (u = f)) : ((h = f), (u = p + 1));
                          h < u;
                          h++
                        )
                          ~fe.indexOf(d[h]) ||
                            ($(d[h], c.selectedClass, !0),
                            fe.push(d[h]),
                            W({
                              sortable: i,
                              rootEl: n,
                ...
                if (be && this.isMultiDrag) {
                  if (
                    ((ve = !1), (o[F].options.sort || o !== n) && fe.length > 1)
                  ) {
                    var m = _(ue),
                      g = B(ue, ":not(." + this.options.selectedClass + ")");
                    if (
                      (!ge && c.animation && (ue.thisAnimationDuration = null),
                      ...
                      !ge &&
                        ...
                        we(),
                        fe.forEach(function (t) {
                          d[g] ? o.insertBefore(t, d[g]) : o.appendChild(t),
                            g++;
                        }),
                        a === B(ue)))
                    ) {
            ...
            nullingGlobal: function () {
              (this.isMultiDrag = be = !1), (me.length = 0);
            },
            ...
            _deselectMultiDrag: function (t) {
              if (
                ...
                for (; fe.length; ) {
                  var e = fe[0];
                  $(e, this.options.selectedClass, !1),
                    fe.shift(),
                    W({
            ...
            utils: {
              ...
              deselect: function (t) {
                ...
                e &&
                  e.options.multiDrag &&
                  ~n &&
                  ($(t, e.options.selectedClass, !1), fe.splice(n, 1));
              },
            },
            eventProperties: function () {
              var t = this,
                  ...
                  e.push({ multiDragElement: o, index: o.sortableIndex }),
                    (i =
                      ve && o !== ue
                        ? -1
                        : ve
                        ? B(o, ":not(." + t.options.selectedClass + ")")
                        : B(o)),
  ...
  document.addEventListener("alpine:init", () => {
    ...
    window.innerWidth < 768 ||
      Alpine.directive(
        "tooltip",
        (e, { modifiers: n, expression: o }, { cleanup: i }) => {
          var r = !1;
          let a = o,
            l = !n.includes("noarrow"),
            s = "top",
            c =
              "tooltip-" +
            ...
            u = getComputedStyle(e).position,
            h = n.includes("white")
              ? "text-gray-800 bg-white border shadow-lg"
              : "px-3 py-2 text-white bg-black",
            p = n.includes("white")
          ...
          ["relative", "absolute", "fixed"].includes(u) ||
          ...
          e.dataset.tooltip = c;
          let m = function (n) {
              if ((null != t && t.dispatchEvent(new Event("mouseleave")), !r)) {
                    ...
                    null != t &&
                      ("top" == s
                        ? ((t.style.top = o.top + window.scrollY + "px"),
                          (t.style.left =
                            o.left + window.scrollX + o.width / 2 + "px"))
                        : "bottom" == s
                        ? ((t.style.top =
                            o.bottom + window.scrollY + o.height + "px"),
                          (t.style.left =
                            o.left + window.scrollX + o.width / 2 + "px"))
                        : "left" == s
                        ? ((t.style.top =
                            o.top + window.scrollY + o.height / 2 + "px"),
                          (t.style.left = o.left + window.scrollX - 12 + "px"))
                        : "right" == s &&
                          ((t.style.top =
                            o.top + window.scrollY + o.height / 2 + "px"),
                          (t.style.left =
                            o.right + window.scrollX + 12 + "px")));
                  }, 50),
                  (r = !0),
                  (t = e);
              }
            ...
            g = function (e) {
              ...
              n && n.remove();
              var o = document.getElementById(c + "Template");
              o && o.remove(), (r = !1), (t = null);
            };
  ...
  document.addEventListener(
    "htmx:confirm",
    function (t) {
      t.detail.elt.hasAttribute("hx-boost") &&
        (t.preventDefault(),
        null != window.onbeforeunload
          ? window.confirm(Gibbon.config.htmx.unload_confirm) &&
            ((window.onbeforeunload = null), t.detail.issueRequest(!0))
          : t.detail.issueRequest(!0));
    },
    !1
  ),
  htmx.onLoad(function (t) {
    $("#sidebarToggle").click(function () {
      $("#sidebar").hasClass("lg:w-sidebar")
      ...
      $(document).on("click", '.checkall[type="checkbox"]', function () {
        ...
        t.parentElement.parentElement
          .closest(".bulkActionForm, .checkboxGroup")
          .querySelectorAll('input[type="checkbox"]')
          .forEach(function (n, o, i) {
            if (n === t) return;
            n.checked = e;
            let r = n.closest("tr");
            null != r && r.classList.toggle("selected", n.checked),
              o == i.length - 1 && $(n).trigger("change");
          });
      }),
      $(document).on(
        "click, change",
        ...
        function () {
          var t = $(this)
            ...
            e = t.filter(":checked").length;
          if (e > 0) {
            if (
              ($(".bulkActionCount span").html(e),
              $(".bulkActionPanel").hasClass("hidden"))
            ) {
              $(".bulkActionPanel").removeClass("hidden");
              var n = $(this)
                  .parents(".bulkActionForm")
                  .find(".dataTable header"),
                o = $(".bulkActionPanel").innerHeight();
              $(".bulkActionPanel").css("top", n.outerHeight(!1) - o + 6),
                $(".bulkActionPanel :input").trigger("showhide");
            }
          } else $(".bulkActionPanel").addClass("hidden");
          $(".checkall").prop("checked", e > 0),
            $(".checkall").prop("indeterminate", e > 0 && e < t.length),
            $(this)
              .closest("tr")
    ...
    var e = $(".columnHighlight td");
    e
      .on("mouseover", function () {
        e.filter(":nth-child(" + ($(this).index() + 1) + ")").addClass("hover");
      })
        ...
        if ("" != $(this).data("source") && "" != $(this).data("confirm")) {
          for (
            ...
            e += t.charAt(
              0 == n
                ...
                : 1 == n
                ? Math.floor(26 * Math.random()) + 26
                : 2 == n
                ? Math.floor(10 * Math.random()) + 52
                : 3 == n
                ? Math.floor(19 * Math.random()) + 62
                : Math.floor(78 * Math.random())
            );
          $('input[name="' + $(this).data("source") + '"]')
            ...
            $('input[name="' + $(this).data("confirm") + '"]')
              ...
              .blur(),
            document
              .getElementById($(this).data("source"))
              .dispatchEvent(new Event("blur")),
            prompt($(this).data("alert"), e);
        }
      }),
      $(".generateUsername").click(function () {
        var t = $(this).data("alert");
        $.ajax({
          type: "POST",
          data: {
    ...
    for (
      var n = t.querySelectorAll("table[data-draggable] tbody"), o = 0;
      o < n.length;
      o++
    ) {
      var i = n[o];
      new Sortable(i, {
        ...
        onMove: function (t) {
          return -1 === t.related.className.indexOf("htmx-indicator");
        },
        onEnd: function (t) {},
      });
    }
  }),
  ($.prototype.gibbonCommentEditor = function (t) {
    var e = this;
    updateComments(e),
      $(e).on("input", function () {
        updateComments(this);
      ...
      $(e).on("paste", function () {
        var t = this;
        setTimeout(function () {
          updatePlaceholders(t), updateComments(t);
        }, 0);
      }),
      $(e).ready(function () {
        autosize(e);
...
(CustomBlocks = function (t, e) {
  var n = this;
  (n.container = $(t)),
    (n.blockTemplate = $(".blockTemplate", t)),
    (n.blockCount = 0),
    (n.identifiers = []),
    (n.validation = []),
    (n.defaults = {
      inputNameStrategy: "object",
      addSelector: ".addBlock",
      addOnEvent: "click",
    ...
    (n.settings = $.extend({}, n.defaults, e)),
    n.init();
}),
  (CustomBlocks.prototype.init = function () {
    var t = this;
    for (var e in ($(t.settings.addSelector, t.container).each(function () {
      $(this).on(t.settings.addOnEvent, function () {
        var e = $(this).val();
        if (e)
          if (t.settings.preventDuplicates && t.identifiers.includes(e))
            alert(t.settings.duplicateMessage);
          else {
            var n = t.settings.predefinedBlocks[e] || {};
            (n.identifier = e), t.addBlock(n), t.identifiers.push(e);
          }
      });
    }),
    t.settings.sortable &&
      ($(".blocks", t.container)
        .sortable({ placeholder: "sortHighlight", handle: ".sortHandle" })
        .bind("sortstart", function (e, n) {
          $(t.container).trigger("hideAll"),
            $("textarea.tinymce", t.container).each(function (t, e) {
      ...
      $(t.blockTemplate).children(".sortHandle").remove(),
      $(t.blockTemplate).prepend('<div class="sortHandle floatLeft"></div>')),
    $(".showHide", t.blockTemplate).hide(),
    $(":input", t.blockTemplate).prop("disabled", !0),
    t.settings.currentBlocks))
      t.addBlock(t.settings.currentBlocks[e]), t.identifiers.push(e);
    $(t.container)
      .on("delete", function (e, n) {
        confirm(t.settings.deleteMessage) && t.removeBlock(n);
      })
      .on("showHide", function (t, e, n) {
        $(n).hasClass("showHidden")
          ? ($(n).removeClass("showHidden"),
            $("img", n).prop("src", $(n).data("off")),
            e.find(".showHide").hide())
          : ($(n).addClass("showHidden"),
            $("img", n).prop("src", $(n).data("on")),
            e.find(".showHide").show(),
            $("textarea.tinymce", e).each(function (t, e) {
              tinymce.EditorManager.execCommand(
                "mceAddEditor",
                !1,
                $(this).prop("id")
      ...
      .on("hideAll", function (t, e, n) {
        $(".showHide").hide(),
          $('a.blockButton[data-event="showHide"]').each(function (t, e) {
            $(e).removeClass("showHidden"),
              $("img", e).prop("src", $(e).data("off"));
          });
      }),
      t.refresh();
  }),
  (CustomBlocks.prototype.addBlock = function (t) {
    var e = this;
    e.blockCount++;
    var n = $(e.blockTemplate)
      .clone()
      .css("display", "block")
      .appendTo($(".blocks", e.container));
    $(n).append(
      '<input type="hidden" name="' +
        e.settings.orderName +
        '[]" value="' +
        e.blockCount +
        '" />'
    ),
      e.initBlock(n, t),
      e.refresh(),
      $(e.container).trigger("addedBlock", [n]);
  }),
  (CustomBlocks.prototype.removeBlock = function (t) {
    var e = this;
    e.blockCount--;
    var n = e.identifiers.indexOf(t.identifier);
    -1 !== n && e.identifiers.splice(n, 1),
      e.removeBlockValidation(t),
      $(t).fadeOut(e.settings.animationSpeed, function () {
        $(t).detach().remove(), e.refresh();
      }),
      $(e.container).trigger("removedBlock", [t]);
  }),
  (CustomBlocks.prototype.initBlock = function (t, e) {
    var n = this;
    (t.blockNumber = n.blockCount),
      (t.identifier = e.identifier),
      n.loadBlockInputData(t, e),
      n.renameBlockFields(t),
      n.addBlockValidation(t),
      n.addBlockEvents(t);
  }),
  (CustomBlocks.prototype.loadBlockInputData = function (t, e) {
    for (key in ($(":input", t).prop("disabled", !1), e))
      $(
        "[name='" +
          key +
        ...
        $("input:radio[name='" + key + "']", t).each(function () {
          $(this).val() == e[key] && $(this).attr("checked", !0);
        }),
        $(
          "input:checkbox[name='" +
            key +
          ...
          (Array.isArray(e[key]) ? e[key] : e[key].split(",")).includes(
            $(this).val()
          ) && $(this).attr("checked", !0);
        });
    (e.readonly || []).forEach(function (e) {
      $("[name='" + e + "']", t)
        .prop("readonly", !0)
        .addClass("readonly"),
        $("select[name='" + e + "'] option:not(:selected)", t).prop(
          "disabled",
          !0
        );
    });
  }),
  (CustomBlocks.prototype.renameBlockFields = function (t) {
    var e = this;
    $("input, textarea, select", t).each(function (n, o) {
      if ($(this).prop("name") != e.settings.orderName + "[]") {
        var i;
        switch (e.settings.inputNameStrategy) {
          case "object":
            i =
              $(e.container).prop("id") +
              "[" +
            ...
            break;
          case "array":
            i = $(this).prop("name") + "[" + t.blockNumber + "]";
            break;
          case "string":
            i = $(this).prop("name") + t.blockNumber;
        }
        (i = i.replace("[]]", "][]")),
          $(this).prop("name", i),
          "" != $(this).prop("id") &&
            $(this).prop("id", $(this).prop("id") + t.blockNumber);
      }
    }),
      $("label", t).each(function (e, n) {
        $(this).prop("for", $(this).prop("for") + t.blockNumber);
      }),
      $("textarea[data-tinymce]", t).each(function (t, e) {
        var n = $(this).is(":hidden"),
          o = {
            id: $(this).prop("id"),
            value: $(this).val(),
        ...
        $(this)
          ...
          .load(
            ...
            o,
            function (t, e, i) {
              n || tinymce.EditorManager.execCommand("mceAddEditor", !1, o.id);
            }
          );
      });
  }),
  (CustomBlocks.prototype.addBlockValidation = function (block) {
    ...
    $("input, textarea, select", block).each(function (index, element) {
      if ($(this).data("validation") && !$(this).prop("readonly")) {
        var id = $(this).prop("id");
        eval(
          "block." + id + "Validate = new LiveValidation('" + id + "', {});"
        ),
          $(this)
            .data("validation")
  ...
  (CustomBlocks.prototype.removeBlockValidation = function (block) {
    ...
    $("input, textarea, select", block).each(function (index, element) {
      ...
      $("textarea.tinymce", block).each(function (t, e) {
        tinymce.EditorManager.execCommand(
          "mceRemoveEditor",
          !1,
          $(this).prop("id")
  ...
  (CustomBlocks.prototype.addBlockEvents = function (t) {
    var e = this;
    $("a.blockButton", t).each(function (n, o) {
      $(o).click(function (n) {
        n.preventDefault(),
          $(e.container).trigger($(this).data("event"), [t, this]);
      });
    });
  }),
  (CustomBlocks.prototype.refresh = function () {
    var t = this;
    $(".blockCount", t.container).val(t.blockCount),
      $(".blockPlaceholder", t.container).css(
        "display",
        t.blockCount > 0 ? "none" : "block"
      ),
      $("select.addBlock", t.container).val("");
  }),
  ($.prototype.gibbonCustomBlocks = function (t) {
    $(this).hasClass("customBlocksInit") && $(".blocks", this).empty(),
      (this.gibbonCustomBlocks = new CustomBlocks(this, t)),$(this).data("gibbonCustomBlocks", this.gibbonCustomBlocks),$(this).addClass("customBlocksInit");
  });
var DataTable = window.DataTable || {};
(DataTable = function (t, e, n, o) {
  var i = this;
  (i.table = $(t)),
    (i.path = e + " #" + $(t).attr("id") + " > .dataTable"),
    (i.filters = n),
    (i.identifier = o),
    0 == i.filters.sortBy.length && (i.filters.sortBy = {}),
    0 == i.filters.filterBy.length && (i.filters.filterBy = {}),
    i.init();
}),
  (DataTable.prototype.init = function () {
    var t = this;
    $(t.table).on("click", ".paginate", function () {
      var e = $(".dataTable", t.table).data("results");
      (t.filters.pageMax = Math.ceil(e / t.filters.pageSize)),
        (t.filters.page = Math.min($(this).data("page"), t.filters.pageMax)),
        t.refresh();
    }),
      $(t.table).on("click", ".column.sortable", function (e) {
        var n = $(this).data("sort").split(",");
        0 !=
          n.filter(function (e) {
            return e in t.filters.sortBy;
          }).length ||
          e.shiftKey ||
          (t.filters.sortBy = {}),
          n.forEach(function (e) {
            t.filters.sortBy[e] = "ASC" == t.filters.sortBy[e] ? "DESC" : "ASC";
          }),
          t.refresh();
      }),
      $(t.table).on("click", ".filter", function () {
        var e = $(this).data("filter");
        $(this).hasClass("clear")
          ? ((t.filters.filterBy = { "": "" }),
            (t.filters.searchBy.columns = [""]))
          : e in t.filters.filterBy &&
            ("in" == e && (t.filters.searchBy.columns = [""]),
            delete t.filters.filterBy[e]),
          jQuery.isEmptyObject(t.filters.filterBy) &&
            (t.filters.filterBy = { "": "" }),
          (t.filters.page = 1),
          t.refresh();
      }),
      $(t.table).on("change", ".filters", function () {
        var e = $(this).val().split(":"),
          n = e[0],
          o = e[1];
        (t.filters.filterBy[n] = o), (t.filters.page = 1), t.refresh();
      }),
      $(t.table).on("change", ".limit", function () {
        var e = $(".dataTable", t.table).data("results");
        (t.filters.pageSize = parseInt($(this).val())),
          (t.filters.pageMax = Math.ceil(e / t.filters.pageSize)),
          (t.filters.page = Math.min(t.filters.page, t.filters.pageMax)),
          t.refresh();
      });
  }),
  (DataTable.prototype.refresh = function () {
    var t = this,
      e = setTimeout(function () {
        $(".pagination", t.table).prepend('<span class="submitted"></span>');
      }, 500),
      n = {};
    "" != t.identifier ? (n[t.identifier] = t.filters) : (n = t.filters),
      $(t.table).load(t.path, n, function (t, n, o) {
  ...
  ($.prototype.gibbonDataTable = function (t, e, n) {
    this.gibbonDataTable = new DataTable(this, t, e, n);
  });
...
(MultiSelect = function (t, e) {
  var n = this;
  (n.container = $(t)),
    (n.selectSource = $("#" + e + "Source", t)),
    (n.selectDestination = $("#" + e, t)),
    (n.name = e),
    (n.sortBy = $("#" + e + "Sort", t)),
    n.init();
}),
  (MultiSelect.prototype.init = function () {
    var t = this;
    $("#" + t.name + "Add").click(function () {
      t.transferOption(!0);
    }),
      $("#" + t.name + "Remove", t.container).click(function () {
        t.transferOption(!1);
      });
    var e = t.container.parents("form");
    $(
      "input[type='Submit'],button[type='Submit'],button[value~='Save']",
      e
    ).click(function () {
      $("option", t.selectDestination).each(function () {
        $(this).prop("selected", !0);
      }),
        document.getElementById(t.name).dispatchEvent(new Event("change"));
    }),
      t.sortBy.change(function () {
        t.sortSelects();
      }),
      $("#" + t.name + "Search", t.container).on(
        "keyup input compositionend",
        function () {
          var e = $(this).val().toLowerCase();
          $("option", t.selectSource).each(function () {
            var t = $(this);
            t.text().toLowerCase().includes(e) ? t.show() : t.hide();
          });
        }
      );
  }),
  (MultiSelect.prototype.transferOption = function (t) {
    var e = this,
      n = t ? e.selectSource : e.selectDestination,
      o = t ? e.selectDestination : e.selectSource;
    n.find("option:selected").each(function () {
      ...
      if ($(this).parent().is("optgroup")) {
        ...
        0 == e.length && ((e = $(this).parent().clone().html("")), o.append(e)),
          t.data("parent", e),
          e.append(t);
      } else o.append(t);
      $(this).detach().remove();
  ...
  (MultiSelect.prototype.sortSelects = function () {
    var t = this,
      e = null,
      n = null;
    0 !== t.sortBy.length && (n = t.sortBy.val()),
      null != n && "Sort by Name" != n && (e = t.container.data("sortable")[n]),
      t.sortSelect(t.selectSource, e),
      t.sortSelect(t.selectDestination, e);
  }),
  (MultiSelect.prototype.sortSelect = function (t, e) {
    var n = this;
    $("optgroup", t).each(function () {
      n.sortSelect($(this), e);
    });
    var o = $("option", t);
    t.is("select") && (o = o.not("optgroup option")), null == e && (e = {});
    var i = o
      .map(function (t, n) {
        return { tSort: e[n.value] + $(n).text(), t: $(n).text(), v: n.value };
      })
      .get();
    i.sort(function (t, e) {
      return t.tSort > e.tSort ? 1 : t.tSort < e.tSort ? -1 : 0;
    }),
      o.each(function (t, e) {
        (e.value = i[t].v), $(e).text(i[t].t);
      });
  }),
  ($.prototype.gibbonMultiSelect = function (t) {
    this.gibbonMultiSelect = new MultiSelect(this, t);
  });
var __GIBBON_URL_DEBOUNCE_MAP = {};
function gibbonFormSubmitQuiet(t, e) {
  var n = $(t).serialize();
  __GIBBON_URL_DEBOUNCE_MAP[e] ||
    (__GIBBON_URL_DEBOUNCE_MAP[e] = debounce(function (t) {
      $.ajax({ type: "POST", data: t, url: e });
    })),
    __GIBBON_URL_DEBOUNCE_MAP[e](n);
}
