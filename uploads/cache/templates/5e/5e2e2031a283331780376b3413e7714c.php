...
/* tray.twig.html */
class __TwigTemplate_281a2238d6fd661c1cff8134d3f9dc80 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return array (  220 => 119,  215 => 117,  206 => 111,  202 => 110,  195 => 106,  190 => 104,  161 => 78,  130 => 50,  126 => 49,  123 => 48,  115 => 42,  113 => 41,  110 => 40,  103 => 36,  94 => 30,  88 => 27,  84 => 26,  77 => 25,  75 => 24,  72 => 23,  64 => 19,  56 => 17,  54 => 16,  46 => 15,  43 => 14,  41 => 13,  38 => 12,);
    }
...
{% if statusTray.messageWall %}
    ...
    <a id=\"messageWall\" x-data=\"{ read: {{ currentUser.messengerRead ? 'true' : 'false' }} }\" hx-boost=\"true\" hx-target=\"#content-wrap\" hx-select=\"#content-wrap\" hx-swap=\"outerHTML show:no-scroll swap:0s\" class=\"inline-block relative mr-5\" title=\"{{ __('Message Wall') }}\" href=\"{{ statusTray.messageWall.url }}\" @click.debounce.500ms=\"read = true\">
        ...
        {% endif %}
        {{ icon('outline', 'message-wall', 'minorLinkIcon size-10 -my-1 fill-current text-white ' ~ (statusTray.messageWall.messages ? 'opacity-100' : 'opacity-100') ) }}
...
{% if statusTray.notifications %}
        <a id=\"notifications\" hx-boost=\"true\" hx-target=\"#content-wrap\" hx-select=\"#content-wrap\" hx-swap=\"outerHTML show:no-scroll swap:0s\" class=\"inline-block relative mr-5\" title=\"{{ __('Notifications') }}\" href=\"{{ statusTray.notifications.url }}\">
            ...
            {{ icon('outline', 'notifications', 'notificationIcon size-8 fill-current text-white ' ~ (statusTray.notifications.count ? 'opacity-100' : 'opacity-100') ) }}
        </a>
...
", "tray.twig.html", "/var/www/GibbonEduCore/resources/templates/tray.twig.html");
    }
}
