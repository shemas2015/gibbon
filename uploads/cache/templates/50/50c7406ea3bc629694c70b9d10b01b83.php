...
class __TwigTemplate_bcc1eef8dd72bb8979e237cdfeb281b3 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 15
        $context["sidebarClass"] = "shadow bg-white rounded-md px-6 mb-6";
        // line 16
        yield "
";
        // line 17
    ...
    ";
            ...
            if (($context["menuModule"] ?? null)) {
                ...
                yield "' }\" class=\"";
                yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["sidebarClass"] ?? null), "html", null, true);
                yield " w-full font-sans absolute top-0 z-30 sm:mt-16 pt-10 pt-12 sm:pt-6
        ";
                // line 55
...
{% set sidebarClass = 'shadow bg-white rounded-md px-6 mb-6' %}
...
<div class=\"mx-4 sm:mx-0 relative sm:static\" x-data=\"{moduleMenu: false}\" @keydown.escape.window=\"moduleMenu = false\" @click.outside=\"moduleMenu = false\" x-init=\"moduleMenu = false\">
    ...
    {% if menuModule %}
    <nav x-cloak=\"{{ sidebar ? 'mobile' : 'on' }}\"  :class=\"moduleMenu ? 'block' : 'hidden'\" x-data=\"{ menuItemActive: '{{ menuItemActive|replace({' ': '-', '&': '', '\\'': ''}) }}' }\" class=\"{{ sidebarClass }} w-full font-sans absolute top-0 z-30 sm:mt-16 pt-10 pt-12 sm:pt-6
...
{% endif %}
", "navigation.twig.html", "/var/www/GibbonEduCore/resources/templates/navigation.twig.html");
    }
}
