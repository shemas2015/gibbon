...
/* footer.twig.html */
class __TwigTemplate_1aa39f62f421b3036289148d982d204f extends Template
{
    private $source;
    private $macros = [];
...
<div class=\"footer-container flex flex-col items-center justify-center\">
    <div class=\"left text-xs\">
        Copyright: © 2024 Student Information System Admin. All Rights Reserved.
    </div>
    <div class=\"right mt-4 text-xs\">
        <div>
            Powered By 
        </div>
        <div class=\"pl-4\">
        ...
        yield "/img/aquinas-logo.png\" alt=\"";
    ...
    {
        return array (  106 => 51,  90 => 38,  83 => 36,  77 => 35,  71 => 34,  65 => 33,  59 => 32,  53 => 31,  42 => 27,  38 => 25,);
    }
...
<div class=\"footer-container flex flex-col items-center justify-center\">
    ...
    <div class=\"right mt-4 text-xs\">
        ...
        <div class=\"pl-4\">
            <img class=\"w-full h-full object-contain\" src=\"{{ absoluteURL }}/themes/{{ gibbonThemeName }}/img/aquinas-logo.png\" alt=\"{{ __('Notifications') }}\" style=\"max-width:100px;\">
        </div>
    </div>
</div>", "footer.twig.html", "/var/www/GibbonEduCore/resources/templates/footer.twig.html");
    }
}
