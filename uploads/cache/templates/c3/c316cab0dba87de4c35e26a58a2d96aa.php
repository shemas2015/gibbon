...
/* menu.twig.html */
class __TwigTemplate_2e7cc5ee38d6cdc09ad4f90ec8ecfd30 extends Template
{
    private $source;
    private $macros = [];
...
<ul class=\"list-none flex flex-wrap items-center my-3 -mx-4\">
    <li class=\"mx-0 px-0\">
        <a hx-boost=\"true\" hx-target=\"#content-wrap\" hx-select=\"#content-wrap\" hx-swap=\"outerHTML show:no-scroll swap:0s\" class=\"block uppercase font-bold text-sm text-black hover:text-gray-800 no-underline ml-1 px-4 py-3\" href=\"";
        // line 16
    ...
    ";
        ...
        if (($context["isLoggedIn"] ?? null)) {
            ...
            <a @mouseenter=\"menuOpen = true\" @click=\"menuOpen = true\" :class=\"{'text-gray-800': menuOpen, 'text-black': !menuOpen}\" class=\"block uppercase font-bold text-sm text-black no-underline px-4 py-3 cursor-pointer\">";
                // line 22
...
<ul class=\"list-none flex flex-wrap items-center my-3 -mx-4\">
    <li class=\"mx-0 px-0\">
        <a hx-boost=\"true\" hx-target=\"#content-wrap\" hx-select=\"#content-wrap\" hx-swap=\"outerHTML show:no-scroll swap:0s\" class=\"block uppercase font-bold text-sm text-black hover:text-gray-800 no-underline ml-1 px-4 py-3\" href=\"{{ absoluteURL }}/index.php\">{{ __('Home') }}</a>
    </li>
    ...
    {% if isLoggedIn %}
        ...
        <li class=\"sm:relative group mx-0 px-0 \" x-data=\"{menuOpen: false}\" @mouseleave=\"menuOpen = false\" @click.outside=\"menuOpen = false\">
            <a @mouseenter=\"menuOpen = true\" @click=\"menuOpen = true\" :class=\"{'text-gray-800': menuOpen, 'text-black': !menuOpen}\" class=\"block uppercase font-bold text-sm text-black no-underline px-4 py-3 cursor-pointer\">{{ __(categoryName) }}</a>
...
", "menu.twig.html", "/var/www/GibbonEduCore/resources/templates/menu.twig.html");
    }
}
